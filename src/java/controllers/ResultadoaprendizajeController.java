...
import facades.ResultadoaprendizajeFacade;
...
public class ResultadoaprendizajeController implements Serializable {
    ...
    @EJB
    private facades.ResultadoaprendizajeFacade ejbFacade;
    ...
    public String prepareView() {
        current = (Resultadoaprendizaje) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ResultadoaprendizajeCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ResultadoaprendizajeUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ResultadoaprendizajeDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Resultadoaprendizaje getResultadoaprendizaje(java.lang.String id) {
